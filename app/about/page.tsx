      ...
      <section className="pt-32 pb-10 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <p className="font-sans text-xl md:text-2xl text-near-black/70 leading-relaxed font-light">
              I&apos;m a strategist, communicator, builder, and{' '}
              <span className="italic text-tangerine font-normal">ice cream aficionado.</span>
            </p>
          </div>
