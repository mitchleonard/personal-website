...
PINTS = [
    ...
    {"name": "Reese’s Peanut Butter Cup and Butterfinger", "base": "Vanilla ice cream", "mix_ins": ["Butterfinger", "Reese’s Peanut Butter Cups", "Chocolate swirl"], "description": "Vanilla ice cream, crushed Butterfinger and Reese’s Peanut Butter Cups with chocolate swirl", "images": [5, 6]},
    ...
    {"name": "Gooey (Cookie) Dough Balls", "base": "Vanilla ice cream", "mix_ins": ["Chocolate shavings", "Grandma’s chocolate sauce", "Marshmallow cream", "Cookie dough balls"], "description": "Vanilla ice cream with semi-sweet chocolate shavings, swirls of Grandma’s chocolate sauce and marshmallow cream, and movie theater cookie dough balls", "images": [12, 13]},
    {"name": "Only the Best Candy", "base": "Oreo ice cream", "mix_ins": ["Grandma’s chocolate sauce", "M&Ms", "Reese’s Peanut Butter Cups"], "description": "Oreo ice cream, swirls of Grandma’s chocolate sauce, crushed M&Ms, and Reese’s Peanut Butter Cups", "images": [14, 15]},
    {"name": "Strawberry Shortbread Cookie", "base": "Vanilla ice cream", "mix_ins": ["Shortbread cookie", "Strawberry topping", "Marshmallow topping"], "description": "Vanilla ice cream, shortbread cookie chunks, and swirls of Smucker’s strawberry and marshmallow topping", "images": [16, 17]},
    {"name": "Banana Pudding", "base": "Banana pudding ice cream", "mix_ins": ["Butterscotch swirl", "Nilla wafers"], "description": "Banana pudding ice cream, butterscotch swirl, and smashed Nila wafers", "images": [18, 19, 20]},
    ...
    {"name": "Luck of the Charm", "base": "Lucky Charm steeped ice cream", "mix_ins": ["Marshmallow layers"], "description": "Lucky Charm steeped ice cream with marshmallow layers", "images": [25, 26]},
